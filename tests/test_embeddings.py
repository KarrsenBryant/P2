...
def test_embed_documents_returns_numpy_array(embedder):
    """Test that embed_documents returns a numpy array with multiple documents."""
...
def test_embed_documents_correct_shape(embedder):
    """Test that the embeddings have the correct shape with multiple documents."""
...
def test_embed_query_returns_numpy_array(embedder):
    """Test that embed_query returns a numpy array with single query."""
...
def test_embed_query_correct_shape(embedder):
    """Test that query embedding has the correct shape with single query."""
    embedding = embedder.embed_query("test query")
